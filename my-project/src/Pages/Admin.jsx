...
import { Bell, Download, Settings, Users, Calendar, Stethoscope, DollarSign, UserPlus, CalendarPlus, FileText, Cog, Eye, Edit, Trash2, Phone, Mail, MapPin, Star } from "lucide-react";
...
export default function Admin() {
  ...
  const getStatusColor = (status) => {
    switch(status) {
      case "Confirmed": return "bg-gray-800 text-white";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {activeTab === "Appointments" && <div className="text-center py-8 text-gray-500">Appointments tab content coming soon...</div>}
